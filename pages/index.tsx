    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Vercel Trick By <a href="https://reviewstruster.000webhostapp.com">Reviews Truster</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://reviewstruster.000webhostapp.com/" className={styles.card}>
          ...
          <a
            href="https://reviewstruster.000webhostapp.com/"
          ...
          <a
            href="https://updatedtopnews.blogspot.com/"
            className={styles.card}
          >
            <h2>News &rarr;</h2>
            <p>
